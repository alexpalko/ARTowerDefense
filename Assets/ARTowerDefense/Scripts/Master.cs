...
public class Master : MonoBehaviour
{
    ...
    private void _SpawnGamePlane()
    {
        ...
        m_GamePlane = Instantiate(GamePlanePrefab, new Vector3(middleX, m_BindingVectors[0].y, middleZ), Quaternion.identity, m_AnchorTransform);
    ...
    private void _SplitPlane()
    {
        ...
        {
            Instantiate(PlaneCornerMarkerPrefab, planeCorner, Quaternion.identity, m_AnchorTransform);
        }
        ...
        {
            Instantiate(DivisionMarkerPrefab, division.Center, Quaternion.identity, m_AnchorTransform);
    ...
    private void _PlaceBase()
    {
        ...
        else
        {
            ...
            m_HomeBase = Instantiate(BasePrefab, baseDivision.Center, Quaternion.identity, m_AnchorTransform);
    ...
    private void _SpawnHomeBase()
    {
        ...
        m_HomeBase = Instantiate(BasePrefab, basePosition, Quaternion.identity, m_AnchorTransform);
        Destroy(m_BaseMarker);
    }
