...
using Assets.ARTowerDefense.Scripts.GameSpaceDetection;
using Assets.ARTowerDefense.Scripts.ObjectManipulation.Gestures;
using GoogleARCore;
using UnityEngine;

namespace Assets.ARTowerDefense.Scripts.ObjectManipulation.Manipulators
{
    /// <summary>
    ...
    public class SelectionManipulator : Manipulator
    {
        ...
        //TODO: Decide whether to remove SelectionVisualization
        ///// <summary>
